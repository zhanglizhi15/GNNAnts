...
# lstm mean pool
mkdir ./log
mkdir -p ./log/betty_micro_batch_train/
save_path='./log/betty_micro_batch_train/'
			...
			do  
				...
				do
					...
					do
						...
						do
						echo ${save_path}
						wf=${save_path}${dataset}_layers_${layers}_${fan_out}_${model}_${nb}_batch_${Aggre}_${md}.log
						echo ${wf}
						python $File \
						--dataset $dataset \
						--aggre $Aggre \
